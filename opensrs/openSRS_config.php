 ...
 */
define('OSRS_USERNAME', Config::get('open_srs.credentials.username'));

/**
 * OpenSRS reseller private Key. Please generate a key if you do not already have one.
 */
define('OSRS_KEY', Config::get('open_srs.credentials.key'));

// see https://github.com/OpenSRS/osrs-toolkit-php
/*
 * OSRS_HOST
