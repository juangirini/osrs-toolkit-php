...
class lookupNameSuggest extends openSRS_base
{
    ...
    private function _domainTLD($domain, $nstlds, $lktlds)
    {
        ...
        if (isSet($this->_dataObject->data->services) && $this->_dataObject->data->services != "") {
            $cmd['attributes']['services'] = explode(";", $this->_dataObject->data->services);
        }

        if (isSet($this->_dataObject->data->languages) && $this->_dataObject->data->languages != "") {
